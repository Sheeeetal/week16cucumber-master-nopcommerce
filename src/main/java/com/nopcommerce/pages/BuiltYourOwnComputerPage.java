...
public class BuiltYourOwnComputerPage extends Utility {
    private static final Logger log = LogManager.getLogger(BuiltYourOwnComputerPage.class.getName());


    public BuiltYourOwnComputerPage() {
